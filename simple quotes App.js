...
const App = () => {
  ...
  const quotes =require('C:/Users/Ashok/ManageExpensive/quotes.json');
      ...
      <View
        ...
        <View style={{flexDirection: 'row',justifyContent:'space-around'}}>
          <TouchableOpacity
            ...
            <FontAwesome name="whatsapp" size={22} color={isSpeaking ? '#fff' : "#5372F0"} />
          </TouchableOpacity>
          <TouchableOpacity
            style={{
              borderWidth: 2,
            ...
            <FontAwesome5 name="instagram" size={22} color="#5372F0" />
          </TouchableOpacity>
          <TouchableOpacity
            style={{
              borderWidth: 2,
